...
title: Threejs
show_image: false
description: oltre webgl, threejs
categories:
  - "Computer Graphics"
...
aliases:
  - /Threejs
  - /1764432741
  - /Computer-Graphics/1764432741
  - /Computer-Graphics/Threejs
book_order: 15
---

[ThreeJS](https://threejs.org/) e un wrapper di [webgl](/1764432738.md) per l'implementazione di applicazioni grafiche 3D che sfruttano lo stack web, si basa sul concetto di grafo di rendering
...
L'oggetto `mesh` rappresenta la singola [mesh 3d poligonale](/1764432735.md), di cui viene definita la geometria e le informazioni di colore e texture, nella scena possono essere presenti $n$ mesh 3D
