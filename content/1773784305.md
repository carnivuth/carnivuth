...
Modalità standard di implementazione dei [cifrari a blocchi](cifrari_simmetrici.md#cifrari-a-blocchi) questa si presenta a diverse vulnerabilità tra cui:
...
Modalità di cifratura che si rifa ai [cifrari a flusso autosincronizzanti](cifrari_simmetrici.md#cifrari-a-flusso) con l'utilizzo di un vettore $IV$  molto adatta alla comunicazione di flussi di dati.
