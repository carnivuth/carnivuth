...
aliases:
  - /Push-down-automaton
  - /1765803864
  - /Linguaggi-e-modelli-computazionali/1765803864
  - /Linguaggi-e-modelli-computazionali/Push-down-automaton
tags: []
book_order: 11
---

Per poter riconoscere i linguaggi di [tipo 2](/1765803858.md) e necessario poter processare stringhe che presentino forme di [self embedding](/1765803858.md#self-embedding), di conseguenza un [automa a stati finiti](/1765803867.md) non sarebbe in grado in quanto dovrebbe avere un numero di stati non noto a priori (*non finiti*)

Viene quindi introdotto il **push down automaton** (PDA), la differenza rispetto a un [automa a stati finiti](/1765803867.md) e la presenza di uno stack quindi la funzione di stato $sfn$  considera anche l'insieme dell alfabeto interno Z come ingresso $sfn:A\times Z \rightarrow S\times Z^*$
...
| ---------------------------------------------------------------- | --------------------------------------------------------------------------------------------- |
| Un PDA riconosce correttamente una frase se essa svuota lo stack | Un PDA riconosce correttamente una frase se raggiunge uno stato finale (*come [RSF](/1765803867.md)*) |
...
A differenza degli [RSF](/1765803867.md) i PDA non sempre possono essere portati in una forma deterministica equivalente, inoltre

> *la classe di linguaggi di [tipo 2](/1765803858.md) coincide con quella riconosciuta da un PDA non deterministico*
...
[grammatiche ll](/1765803853.md)
Risulta quindi necessario definire un sottoinsieme di linguaggi di [tipo 2](/1765803858.md) che siano riconoscibili in maniera deterministica guardando al più $k$ simboli in avanti, e il caso delle [grammatiche llk](/1765803853.md)
