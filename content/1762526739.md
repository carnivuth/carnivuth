...
layout: simple
aliases:
  - /databases_tecnologies/sorting/index.md
  - /databases_tecnologies/sorting
permalink: /databases_tecnologies/sorting/index.md
...
L'azione di sort dei dati non e un operatore dell'algebra ma risulta molto utile per risolvere alcune situazioni tra cui query `ORDER BY`, [bulk loading](/databases_tecnologies/b+tree#bulk-loading) degli indici e operatori di `JOIN` e `GROUP BY`.
...
## Sorting con [b+tree](/databases_tecnologies/b+tree)

Nel caso di ordinamento con [b+tree](/databases_tecnologies/b+tree) e necessario distinguere tra le tipologie di indice
