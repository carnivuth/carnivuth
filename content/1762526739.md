...
aliases:
  ...
  - /1762526739
  - /Database-Technologies-and-Designs/1762526739
  - /Database-Technologies-and-Designs/Ordinare-i-dati-sort
...
L'azione di sort dei dati non e un operatore dell'algebra ma risulta molto utile per risolvere alcune situazioni tra cui query `ORDER BY`, [bulk loading](/1762526719.md#bulk-loading) degli indici e operatori di `JOIN` e `GROUP BY`.
...
## Sorting con [b+tree](/1762526719.md)

Nel caso di ordinamento con [b+tree](/1762526719.md) e necessario distinguere tra le tipologie di indice
