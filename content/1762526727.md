...
In questo caso e possibile utilizzare un indice [b+tree](/b+tree) su entrambi gli attributi oppure 2 indici monodimensionali su i due attributi
...
Tecnica basata su una hash directory fatta a griglia $n$-dimensionale dove ogni cella corrisponde a una datapage **ma non e vero il contrario**, estendendo il concetto di [extendible hashing](/indici_hash#extendible-hashing) al caso multidimensionale.
