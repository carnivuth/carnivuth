...
date: 2025-02-16
layout: simple
permalink: /databases_tecnologies/indici_multidimensionali/index.md
...
## Limiti del [b+tree](/databases_tecnologies/b+tree)
...
In questo caso e possibile utilizzare un indice [b+tree](/databases_tecnologies/b+tree) su entrambi gli attributi oppure 2 indici monodimensionali su i due attributi
...
Tecnica basata su una hash directory fatta a griglia $n$-dimensionale dove ogni cella corrisponde a una datapage **ma non e vero il contrario**, estendendo il concetto di [extendible hashing](/databases_tecnologies/indici_hash#extendible-hashing) al caso multidimensionale.
...
>[!NOTE] tutte le problematiche e considerazioni fatte per l'[extendible hashing](/databases_tecnologies/indici_hash#extendible-hashing) restano valide
