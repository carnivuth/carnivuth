...
Tecnica basata su una hash directory fatta a griglia $n$-dimensionale dove ogni cella corrisponde a una datapage **ma non e vero il contrario**, estendendo il concetto di [extendible hashing](1762526725.md_hash#extendible-hashing) al caso multidimensionale.
...
>[!NOTE] tutte le problematiche e considerazioni fatte per l'[extendible hashing](/indici_hash#extendible-hashing) restano valide
