...
aliases:
  ...
  - /1765803858
  - /Linguaggi-e-modelli-computazionali/1765803858
  - /Linguaggi-e-modelli-computazionali/Grammatiche-di-tipo-2-context-free
...
Per le [grammatiche di tipo 2](/1765803858.md) si introduce il concetto di albero di derivazione, dato l'insieme delle produzioni $P$ si ha che :
...
Questa struttura e possibile solo per le grammatiche di tipo 2, le grammatiche di [tipo 1](/1765803857.md) e [0](/1765803856.md) ammettendo a sinistra più di un membro genererebbero un grafo e non un albero
