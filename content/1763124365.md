---
aliases:
  - /Dotfiles,-how-i-started-my-linux-adventure
  - /1763124365
  - /posts/1763124365
  - /posts/Dotfiles,-how-i-started-my-linux-adventure
book:
categories:
  - "posts"
date: 2024-11-16
...
- install [git](/1762518367.md) and vim

```bash
pacman -S git vim
```

- run the official installation script, here i leave a sample of the [configuration](/posts/user_configuration.json) file
