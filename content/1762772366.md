...
To make kubernetes do something when a CRD item is created a [controller](#controllers-and-control-loops) needs to listen for the creation event and do something to fullfill the creation and management of that item
