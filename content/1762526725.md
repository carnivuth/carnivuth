...
layout: simple
aliases:
  - /databases_tecnologies/indici/index.md
  - /databases_tecnologies/indici
permalink: /databases_tecnologies/indici/index.md
date: 2025-01-30
...
[L'organizzazione dei file](/databases_tecnologies/gestione_disco#organizzazione-dei-file) da sola non e sufficiente, in molti casi sia [Heap file](/databases_tecnologies/gestione_disco#heap-file) che [Sequential file](/databases_tecnologies//gestione_disco#sequential-file) hanno i loro limiti, per esempio la ricerca nel primo caso e costosa e nel secondo e efficiente solo se effettuata sul campo di ordinamento del file
