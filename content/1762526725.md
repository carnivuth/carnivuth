...
[L'organizzazione dei file](/gestione_disco#organizzazione-dei-file) da sola non e sufficiente, in molti casi sia [Heap file](/gestione_disco#heap-file) che [Sequential file](//gestione_disco#sequential-file) hanno i loro limiti, per esempio la ricerca nel primo caso e costosa e nel secondo e efficiente solo se effettuata sul campo di ordinamento del file
