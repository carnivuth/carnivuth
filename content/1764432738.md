...
categories:
  - "Computer Graphics"
date: 2025-01-03
description: Rendering avanzato con webgl
draft: false
show_image: false
...
Fase della pipeline che consente di eseguire operazioni custom sui fragment per mezzo di **buffer** un esempio e il [test di profondità](/1764432737.md#algoritmo-z-buffer)
...
Implementa l'algoritmo [z-buffer](/1764432737.md#algoritmo-z-buffer)
