...
draft: false
title: Esame
description: Miei esempi per l'esame
aliases:
  - /Esame
  - /1765803851
  - /Linguaggi-e-modelli-computazionali/1765803851
  - /Linguaggi-e-modelli-computazionali/Esame
tags: []
...
>[!NOTE] si vedeva subito anche dal fatto che la prima regola di produzione presenta [self embedding](/1765803858.md#self-embedding) e il corrispondente automa a stati finiti avrebbe avuto infiniti stati

### Calcolo dei [director symbols set](/1765803853.md#director-symbols-set)
...
si ha un conflitto nei [director symbols set](/1765803853.md#director-symbols-set) che riguardano il metasimbolo $c$ dato che si ha $dss(c \rightarrow c)$ non disgiunto con $dss(c\rightarrow cd)$ la grammatica non e $ll(1)$
...
### Calcolo dei [contesti sinistri](/1765803854.md#contesti-sinistri-di-una-produzione)
...
### Calcolo dei [contesti lr(0)](/1765803854.md#contesti$lr\(0\))
...
La grammatica in questione non risulta essere [lr(0)](/1765803854.md#analisi-$lr\(0\)$) in quanto la regola di produzione $B \rightarrow \epsilon$ genera un conflitto shift/reduce nell'automa
...
con il potentissimo costrutto `lesect`  e la possibilità offerta da javascript di [costruire funzioni dinamicamente](/1765803860.md#costruire-funzioni-dinamicamente) si possono ricreare molti tool unix semplicemente modificando un file,
...
Mostrare come scala risolve il problema dell'ereditarietà multipla per mezzo dei [tratti](/1765803862.md), e le limitazioni dei tratti parametrici
