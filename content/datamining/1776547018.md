...
- each center must be the [centroid](/1776546998.md#CENTROID) of the points it owns
...
- choose a new [centroid](/1776546998.md#CENTROID)  away from the empty one
- choose a new [centroid](/1776546998.md#CENTROID) at random with the maximum **SSE** in order to split in half the cluster with the lowest quality


## outliers

there can be points far away from the  [centroid](/1776546998.md#CENTROID), this points are a bad influence for the [SSE](#DISTORTION_(*SUM_OF_SQUARE_ERRORS_SSE*)), in some cases this points need to be removed
## complexity
...
- k-means cannot work in space where [distance](/1776547012.md) cannot be computed
