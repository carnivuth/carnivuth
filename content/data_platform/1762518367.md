...
Scaling up a single machine to manage big data implies a lot of problems [Scale up vs scale out](databases_technologies/1740697200.md#Scale%20up%20vs%20scale%20out) scale out, scale out is much simpler but problems like

## Distributed filesystem for scale out solutions

In order to scale out resources for big data a [distributed filesystem](databases_technologies/1740697200.md#Gestire%20i%20dati%20in%20infrastrutture%20distribuite%20distributed%20filesystem%20dfs) istributed filesystem is required to share the storage resources , one of the solution is HDFS
...
| pros                                                                                      | cons                                     |
| ----------------------------------------------------------------------------------------- | ---------------------------------------- |
| relational algebra for [query optimization](databases_technologies/1762526731.md) | fixed schema that is difficult to update |
...
![](static/Pasted%20image%2020251107160759.png)
