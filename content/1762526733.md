...
layout: simple
aliases:
  - /databases_tecnologies/proiezione/index.md
  - /databases_tecnologies/proiezione
permalink: /databases_tecnologies/proiezione/index.md
...
L'[operatore](/databases_tecnologies/operatori_relazionali) di proiezione consente di eliminare attributi dal risultato di una query, data una query del tipo:
...
## Proiettare [ordinando](/databases_tecnologies/sorting)
...
- si ordina per mezzo del [merge sort](/databases_tecnologies/sorting#merge-sort-esterno)
- si eliminano i duplicati

costo complessivo dato da $P(R) +P(T) + 2P(T)\lceil \log_ZP(T)\rceil + P(T)$

>[!TIP] si possono squashare la rimozione degli attributi con la fase di sorting e l'eliminazione dei duplicati nella fase di merging del [merge sort](/databases_tecnologies/sorting#merge-sort-esterno)
...
## Proiettare con un [indice](/databases_tecnologies/indici)
...
>[!TIP] in caso di indice [b+tree](/databases_tecnologies/b+tree) se gli attributi sono un prefisso della chiave basta scandire le foglie eliminando i duplicati con costo $L$
