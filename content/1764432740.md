...
id: TEXTURE_MAPPING
draft: false
description: Strategie di mapping delle texture
book: "Computer Graphics"
aliases:
  - /Texture-mapping
  - /1764432740
  - /Computer-Graphics/1764432740
  - /Computer-Graphics/Texture-mapping
tags: []
book_order: 8
image: /Pasted-image-20250102152917.png
---
...
![](/Pasted-image-20250102151554.png)

### Implementazione in contesto [z-buffer](/1764432737.md#algoritmo-z-buffer)

L'algoritmo [z-buffer](1764432737.md#algoritmo-z-buffer) implica una computazione pixel per pixel, per implementare il texture mapping in questo contesto si applica la trasformazione inversa per ottenere un immagine del pixel (*detto **texel***), nello spazio texture
...
![](/Pasted-image-20250102152917.png)
...
![](/Pasted-image-20250102153322.png)
...
![](/Pasted-image-20250102154853.png)
...
![](/Pasted-image-20250102155114.png)
...
![](/Pasted-image-20250102155433.png)
