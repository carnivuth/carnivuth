...
aliases:
  ...
  - /1764432737
  - /Computer-Graphics/1764432737
  - /Computer-Graphics/Algoritmi-di-real-time-rendering
book: "Computer Graphics"
book_order: 3
categories:
  - "Computer Graphics"
date: 2024-12-11
description: Algoritmi di posizionamento di un vertice nell'immagine
draft: false
id: REAL_TIME_RENDERING
image: /Pasted-image-20241210171450.png
show_image: false
...
![](/Pasted-image-20241210171450.png)
...
![](/Pasted-image-20241210171934.png)
...
![](/Pasted-image-20241210172244.png)
...
A seguito della [trasformazione di vista](/1764432743.md) si rasterizza la faccia e per ogni pixel viene presa in considerazione la distanza Z, se questa e minore di quanto presente nello z buffer si disegna il pixel e si aggiorna lo z-buffer di conseguenza
