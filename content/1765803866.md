...
aliases:
  - /Pumping-lemma
  - /1765803866
  - /Linguaggi-e-modelli-computazionali/1765803866
  - /Linguaggi-e-modelli-computazionali/Pumping-lemma
tags: []
book_order: 9
---

È una condizione necessaria (*ma non sufficiente*) per dimostrare che un linguaggio è di [tipo 2](/1765803858.md) o di [tipo 3](/1765803855.md), si basa sul concetto che in un linguaggio infinito a un certo punto **deve essere presente una stringa motore che viene ripetuta $n$ volte** (*pompata*) per ottenere nuove stringhe del linguaggio
