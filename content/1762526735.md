...
layout: simple
aliases:
  - /databases_tecnologies/rankSQL/index.md
  - /databases_tecnologies/rankSQL
permalink: /databases_tecnologies/rankSQL/index.md
...
Una delle sfide nelle query [top k](/databases_tecnologies/top_k_queries) e quello  di introdurre nei DBMS il concetto di ranking, come first class citizen, un primo approccio al problema e stato fornito dal progetto RankDB definendo i seguenti concetti:
