...
aliases:
  ...
  - /1765803865
  - /Linguaggi-e-modelli-computazionali/1765803865
  - /Linguaggi-e-modelli-computazionali/Costrutti-linguistici-e-processi-computazionali
...
Se il linguaggio supporta le chiusure occorre definire quale sia [l'ambiente](/1765803859.md#environment) della funzione stessa in cui questo deve operare:
...
La modalità in catena dinamica ha un grosso svantaggio, ovvero riduce la leggibilità del programma in quanto per comprendere il valore di una variabile libera e necessario ripercorrere mentalmente il runtime del programma e risalire dunque al valore della variabile stessa
...
Il modello per la valutazione di funzioni più utilizzato e quello applicativo
...
La valutazione immediata dei parametri può portare a fallimenti non necessari in caso quei parametri non vengano utilizzati
...
- i parametri sono **oggetti eseguibili computazionalmente esosi** (*sicuramente più di un valore secco o un indirizzo*)
...
Uno dei casi più famosi di call by name sono le MACRO del C
...
Tuttavia il modello call by name può essere ricreato (*in maniera sintatticamente esplicita*) nei linguaggi che supportano le funzioni come first class entities, **passando degli oggetti funzione come parametri**
