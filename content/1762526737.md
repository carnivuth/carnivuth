...
- indice un-clustered (costo $h-1 + f*L + E *\Phi(N/NK,P)$) (*si fa uso del [Modello di cardenas](/b+tree#modello-di-cardenas)*)
...
- i [b+tree](/b+tree) possono essere utilizzati solo se i termini presenti compongono un prefisso delle chiavi dell'albero (*si fa riferimento a [indici multi attributo](/b+tree#ricerche-multi-attributo)*)
