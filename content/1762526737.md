...
layout: simple
aliases:
  - /databases_tecnologies/selezione/index.md
  - /databases_tecnologies/selezione
permalink: /databases_tecnologies/selezione/index.md
...
- indice un-clustered (costo $h-1 + f*L + E *\Phi(N/NK,P)$) (*si fa uso del [Modello di cardenas](/databases_tecnologies/b+tree#modello-di-cardenas)*)
...
- gli [indici hash](/databases_tecnologies/indici_hash) possono essere utilizzati solo se sono presenti termini di uguaglianza per ogni attributo chiave dell'indice
- i [b+tree](/databases_tecnologies/b+tree) possono essere utilizzati solo se i termini presenti compongono un prefisso delle chiavi dell'albero (*si fa riferimento a [indici multi attributo](/databases_tecnologies/b+tree#ricerche-multi-attributo)*)
