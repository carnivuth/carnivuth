...
aliases:
  - /Selezione
  - /1762526737
  - /Database-Technologies-and-Designs/1762526737
  - /Database-Technologies-and-Designs/Selezione
...
draft: false
id: selezione
image: /selezione_indice_unclustered.png
layout: simple
show_image: false
...
- indice un-clustered (costo $h-1 + f*L + E *\Phi(N/NK,P)$) (*si fa uso del [Modello di cardenas](/1762526719.md#modello-di-cardenas)*)
...
- gli [indici hash](/1762526726.md) possono essere utilizzati solo se sono presenti termini di uguaglianza per ogni attributo chiave dell'indice
- i [b+tree](/1762526719.md) possono essere utilizzati solo se i termini presenti compongono un prefisso delle chiavi dell'albero (*si fa riferimento a [indici multi attributo](1762526719.md#ricerche-multi-attributo)*)
