...
aliases:
  - /Image-filters
  - /1774305292
  - /computer-vision/1774305292
  - /computer-vision/Image-filters
book: computer vision
book_order: 15
date: "2024-02-29"
description: Improve image quality before processing
draft: true
image: /1777217916.png
show_image: false
...
tags:
  - filters
thumbnail: /1777217916.png
title: Image filters
---

Image filters are operators that given a 2D input image calculate the new intensity of a pixel based on considerations on the neighborhood, an important class of filters are the [linear and translation equivariant](1774305292.md) filters.

![](/1777217850.png)

 [LTE filters](1774305292.md) are olso used in [CNN](1774305280.md) as feature extractors
