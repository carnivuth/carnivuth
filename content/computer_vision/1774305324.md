...
aliases:
  - /Zhang-method
  - /1774305324
  - /computer-vision/1774305324
  - /computer-vision/Zhang-method
book: computer vision
book_order: 12
date: "2023-10-31"
description: "How to calibrate cameras"
draft: true
image: /1777217910.png
show_image: false
...
Corners can be detected easily from the image by using the [Harris detector](1774305288.md)
...
Given this setup with the **WRF** parallel to the $Z$ axis we can consider the control point to have $z=0$ so the relation with the image points **became a [HOMOGRAPHY](1774305289.md)**
