...
aliases:
  - /Alexnet
  - /1774305268
  - /computer-vision/1774305268
  - /computer-vision/Alexnet
book: computer vision
book_order: 51
date: "2024-10-01"
description: CNN that won the ILSVRC2012, powerfull network trained on 2 gpus
draft: true
image: /1777217846.png
images:
  - /1777217846.png
locale: en-US
show_image: false
...
tags:
  - cnn
thumbnail: /1777217846.png
title: Alexnet
---


[CNN](1774305280.md) that won the [ILSVRC](https://www.image-net.org/challenges/LSVRC/2012/)2012, powerfull network trained on 2 gpus

![](/1777217846.png)

## Stride parameter

first conv layer has a [stride](1774305280.md#STRIDED-CONVOLUTION) of 4 to reduce the spatial dimension of input e reduce the computational costs, other layers as a stride of 1

## [POOLING LAYERS](1774305280.md#POOLING-LAYERS)

the first 2 layers of the network are intervaled from a max pooling layer

## Implementation of non linearity

All layers (*Conv and FC*) deploy [ReLU](1774305282.md#ACTIVATION-FUNCTION), non-linearities which yield faster training compared to saturating non-linearities

## [FULLY CONNECTED LAYERS](1774305282.md#FULLY-CONNECTED-LAYERS) SETUP
...
Training was performed using random-cropping of $224\times 224$ patches (*and their* *horizontal reflections*) from the $256\times 256$ RGB input images and colour jittering (*massive [data augmentation](1774305299.md#DATA-AUGMENTATION)*).
