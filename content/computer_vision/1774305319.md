...
aliases:
  ...
  - /1774305319
  - /computer-vision/1774305319
  - /computer-vision/Stereo-camera-calibration
book: computer vision
book_order: 13
date: "2024-02-27"
description: Calibration in stereo camera systems
draft: true
image: /1777217911.png
locale: en-US
show_image: false
...
tags:
  - stereo
thumbnail: /1777217911.png
title: Stereo camera calibration
images:
  - /1777217911.png
---

##  Why not calibrate both cameras with [zhang](1774305324.md)

In order to calibrate a stereo camera system the $PPM$ alone is not sufficient, the rigid motion between cameras is also needed, a first approach could be to compute the [zhang's method](1774305324.md) for both cameras but this approach as one major flaw, is not robust to noise
...
The first guess is obtained as the median between the $R_{i}$ $T_{i}$ computed by chaining the [transformations](1774305307.md#ACCOUNTING-FOR-ROTATION-AND-TRANSLATION) $G_i(G_j^{-1})$
...
This is done by virtually rotating the calibrated cameras (e.g. redefining the $PPMs$ ) about their optical center through an [homography](1774305289.md)
...
Both images go trough a rotation and a change of intrinsic parameter, so they are related to the originals through [homographies](1774305289.md)
...
with a calibrated stereo system the [depth information](1774305320.md) and also 3D coordinates can be estimated, so given the relation between 3D point and image points
