...
Cifrario asimmetrico che sfrutta il problema della [fattorizzazione di un numero primo](pages/sicurezza_informazione/problemi_difficili.md#fattorizzazione-di-un-numero-primo) in cui la chiave pubblica e formata da due numeri $n,e$ (*noti*) e la privata da $n,d$ (*privati*)
