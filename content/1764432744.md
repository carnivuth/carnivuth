...
categories:
  - "Computer Graphics"
date: 2025-01-02
description: libreria per il rendering 3D nel browser
draft: false
id: WEBGL
image: /Pasted-image-20250101145433.png
show_image: false
...
![](/Pasted-image-20250101145433.png)
...
Per poter renderizzare un oggetto 3D e necessario implementare la [pipeline di vista](/1764432743.md) con scaling e [proiezione prospettica](/1764432736.md), che si traduce nel definire le matrici $VM$ $S$ e applicare la [trasformazione magica](/1764432736.md#trasformazione-magica)
...
## Implementazione dell' [illuminazione](/1764432734.md)

L'illuminazione deve essere implementata con opportuni shader/vertex program (*l'esempio che segue implementa il [illuminazione](/1764432734.md#gouraud-shading)*):
