...
aliases:
  - /Linguaggi-blended
  - /1765803862
  - /Linguaggi-e-modelli-computazionali/1765803862
  - /Linguaggi-e-modelli-computazionali/Linguaggi-blended
...
- funzioni come [first class entities](/1765803865.md#funzioni-come-first-class-entities)
...
Le funzioni sono introdotte da una parola chiave prefissa (*scala:`def`,kotlin:`func`*) possono essere definite anche a top level (*senza classi wrapper*)   Inoltre la specifica di tipo e postfissa a differenza di java per facilitare l'uso del **motore di type inference** (*molto avanzato*) come gia specificato le funzioni sono [first class entities](/1765803865.md#funzioni-come-first-class-entities)

Inoltre entrambi i linguaggi attuano [ottimizzazione della tail recursion](/1765803865.md#tail-recursion-optimization)
