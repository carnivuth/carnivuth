...
aliases:
  ...
  - /1773784306
  - /information-security/1773784306
  - /information-security/Pretty-good-privacy-(pgp)
tags: []
book_order: 14
---

Protocollo di sicurezza pensato per scambiare documenti in modo sicuro (*email e file storage*), compatibile con differenti sistemi di messaggistica email, fornisce anche servizi di autenticazione per mezzo di meccanismi di [firma digitale](/1773784308.md#firma-digitale).

## Pgp e la riservatezza

per lo scambio di informazioni viene applicato un [cifrario ibrido](/1773784295.md#cifrario-ibrido) con [rsa](/1773784311.md), i messaggi scambiati contengono il testo cifrato, la chiave k  per la cifratura simmetrica che a sua volta viene cifrata con la chiave pubblica della destinazione.
...
la cifratura simmetrica avviene per mezzo del [CFB](/1773784306.md#cipher-feedback-(cfb)).
