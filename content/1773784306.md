...
per lo scambio di informazioni viene applicato un [cifrario ibrido](cifrari_asimmetrici.md#cifrario-ibrido) con [rsa](rsa.md), i messaggi scambiati contengono il testo cifrato, la chiave k  per la cifratura simmetrica che a sua volta viene cifrata con la chiave pubblica della destinazione.
