---
aliases:
  - /Escape-from-self-hosting-in-subpaths
  - /1763124360
  - /posts/1763124360
  - /posts/Escape-from-self-hosting-in-subpaths
book:
categories:
  - "posts"
date: 2024-11-28
...
In my daily work i use some self hosted services in my personal proxmox instance managed trough [ansible](/1762772358.md) and [terraform](/1762772376.md), some of them are exposed to the internet via reverse proxy with `nginx`.
