...
layout: simple
aliases:
  - /databases_tecnologies/skyline_queries/index.md
  - /databases_tecnologies/skyline_queries
permalink: /databases_tecnologies/skyline_queries/index.md
...
Le query [top k](/databases_tecnologies/top_k_queries) hanno dei limiti in termine di espressività, in quanto possono solo catturare preferenze che si **traducono in valori numerici**
...
- sfruttare un [indici](/databases_tecnologies/indici)
...
## Computare la skyline con [r-tree](/databases_tecnologies/r-tree)
