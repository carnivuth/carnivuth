...
layout: simple
aliases:
  - /databases_tecnologies/operatori_modifica/index.md
  - /databases_tecnologies/operatori_modifica
permalink: /databases_tecnologies/operatori_modifica/index.md
...
- costo di modifica
- costo di aggiornamento di [indici](/databases_tecnologies/indici)

## Costo di inserimento

In caso di inserimento in [file non ordinato](/databases_tecnologies/gestione_disco#heap-file) e necessario considerare il costo di aggiunta in fondo al file  e di modifica degli indici:
...
- scansione ordinata $\Phi(E,P)$ con $E = f*N$ (*fare riferimento a [questa sezione](/databases_tecnologies/operatori_relazionali#stime-di-costo-di-un-operatore)*)
...
>[!TIP] In  un database oracle il clustering dei dati equivale ad usare un [b+tree](/databases_tecnologies/b+tree) per organizzare i dati e gli altri indici hanno come valori delle foglie dei RID logici (*i valori della primary key*) che aggiunge un livello di indirezione
