...
In caso di inserimento in [file non ordinato](/gestione_disco#heap-file) e necessario considerare il costo di aggiunta in fondo al file  e di modifica degli indici:
...
- scansione ordinata $\Phi(E,P)$ con $E = f*N$ (*fare riferimento a [questa sezione](/operatori_relazionali#stime-di-costo-di-un-operatore)*)
