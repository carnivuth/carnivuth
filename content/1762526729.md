...
aliases:
  ...
  - /1762526729
  - /Database-Technologies-and-Designs/1762526729
  - /Database-Technologies-and-Designs/Operatori-di-modifica
categories:
...
- costo di modifica
- costo di aggiornamento di [indici](/1762526725.md)

## Costo di inserimento

In caso di inserimento in [file non ordinato](/1762526722.md#heap-file) e necessario considerare il costo di aggiunta in fondo al file  e di modifica degli indici:
...
- scansione ordinata $\Phi(E,P)$ con $E = f*N$ (*fare riferimento a [questa sezione](/1762526730.md#stime-di-costo-di-un-operatore)*)
...
>[!TIP] In  un database oracle il clustering dei dati equivale ad usare un [b+tree](/1762526719.md) per organizzare i dati e gli altri indici hanno come valori delle foglie dei RID logici (*i valori della primary key*) che aggiunge un livello di indirezione
