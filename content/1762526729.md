...
- costo di modifica
- costo di aggiornamento di [indici](/indici)
...
>[!TIP] In  un database oracle il clustering dei dati equivale ad usare un [b+tree](/b+tree) per organizzare i dati e gli altri indici hanno come valori delle foglie dei RID logici (*i valori della primary key*) che aggiunge un livello di indirezione
