...
layout: simple
aliases:
  - /databases_tecnologies/join/index.md
  - /databases_tecnologies/join
permalink: /databases_tecnologies/join/index.md
...
> lasciamo perdere l'opzione di fare il prodotto cartesiano e applicare una [selezione](/databases_tecnologies/selezione).....
...
e possibile utilizzare un indice per accedere alla relazione interna, il costo dipende dal tipo di indice (*[b+tree](/databases_tecnologies/b+tree) oppure [indici_hash](/databases_tecnologies/indici_hash)*) e da se l'indice e clustered o meno
