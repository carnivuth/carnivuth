...
e possibile utilizzare un indice per accedere alla relazione interna, il costo dipende dal tipo di indice (*[b+tree](/b+tree) oppure [indici_hash](/indici_hash)*) e da se l'indice e clustered o meno
