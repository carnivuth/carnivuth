...
>[!WARNING] questo approccio e estremamente costoso in quanto prevede il [sorting](/sorting) di tutte le tuple, ancora peggio se la query prevede uno o più [join](/join)
...
Una possibilità per risolvere le query top-$k$ e quello di usare [b+tree multiattributo](/b+tree#ricerche-multi-attributo), questa soluzione non e ottimale. e molto meglio usare indici multidimensionali come i [r-tree](/r-tree)
