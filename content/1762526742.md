...
aliases:
  - /Top-k-queries
  - /1762526742
  - /Database-Technologies-and-Designs/1762526742
  - /Database-Technologies-and-Designs/Top-k-queries
image: /top_k_query.png
categories:
...
>[!WARNING] questo approccio e estremamente costoso in quanto prevede il [sorting](/1762526739.md) di tutte le tuple, ancora peggio se la query prevede uno o più [join](1762526728.md)
...
- numero di relazioni da accedere, valori [aggregati](/1762526724.md)
...
> [!TIP]
> questo operatore puo lavorare in [pipeline](/1762526731.md#implementare-lesecuzione-in-pipeline-interfaccia-a-iteratore)
- **top-sort** la stream non e ordinata e l'operatore la deve ordinare per poi fornire le tuple in output
>[!WARNING] questa implementazione non può lavorare in [pipeline](/1762526731.md#implementare-lesecuzione-in-pipeline-interfaccia-a-iteratore) in quanto necessita di fare [sorting](1762526739.md)
...
Una possibilità per risolvere le query top-$k$ e quello di usare [b+tree multiattributo](/1762526719.md#ricerche-multi-attributo), questa soluzione non e ottimale. e molto meglio usare indici multidimensionali come i [r-tree](1762526734.md)
>[!NOTE] i b+tree multi-attributo mostrano gli stessi problemi che si hanno in caso di [window query](/1762526727.md#limiti-del-b+tree)
