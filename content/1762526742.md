...
layout: simple
aliases:
  - /databases_tecnologies/top_k_queries/index.md
  - /databases_tecnologies/top_k_queries
permalink: /databases_tecnologies/top_k_queries/index.md
...
>[!WARNING] questo approccio e estremamente costoso in quanto prevede il [sorting](/databases_tecnologies/sorting) di tutte le tuple, ancora peggio se la query prevede uno o più [join](/databases_tecnologies/join)
...
- numero di relazioni da accedere, valori [aggregati](/databases_tecnologies/group_by)
...
> [!TIP]
> questo operatore puo lavorare in [pipeline](/databases_tecnologies/ottimizzazione_interrogazioni#implementare-lesecuzione-in-pipeline-interfaccia-a-iteratore)
- **top-sort** la stream non e ordinata e l'operatore la deve ordinare per poi fornire le tuple in output
>[!WARNING] questa implementazione non può lavorare in [pipeline](/databases_tecnologies/ottimizzazione_interrogazioni#implementare-lesecuzione-in-pipeline-interfaccia-a-iteratore) in quanto necessita di fare [sorting](/databases_tecnologies/sorting)
...
Una possibilità per risolvere le query top-$k$ e quello di usare [b+tree multiattributo](/databases_tecnologies/b+tree#ricerche-multi-attributo), questa soluzione non e ottimale. e molto meglio usare indici multidimensionali come i [r-tree](/databases_tecnologies/r-tree)
>[!NOTE] i b+tree multi-attributo mostrano gli stessi problemi che si hanno in caso di [window query](/databases_tecnologies/indici_multidimensionali#limiti-del-b+tree)
