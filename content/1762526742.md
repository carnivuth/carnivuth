...
>[!WARNING] questo approccio e estremamente costoso in quanto prevede il [sorting](/sorting) di tutte le tuple, ancora peggio se la query prevede uno o più [join](1762526728.md)
...
>[!WARNING] questa implementazione non può lavorare in [pipeline](/ottimizzazione_interrogazioni#implementare-lesecuzione-in-pipeline-interfaccia-a-iteratore) in quanto necessita di fare [sorting](/sorting)
...
Una possibilità per risolvere le query top-$k$ e quello di usare [b+tree multiattributo](1762526719.md#ricerche-multi-attributo), questa soluzione non e ottimale. e molto meglio usare indici multidimensionali come i [r-tree](/r-tree)
