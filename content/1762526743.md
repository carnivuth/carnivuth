...
aliases:
  - /Transazioni
  - /1762526743
  - /Database-Technologies-and-Designs/1762526743
  - /Database-Technologies-and-Designs/Transazioni
image: /strict_2_phase_lock_protocol.png
date: 2025-02-08
id: transazioni
title: Transazioni
...
Garantire tali proprietà e compito dei  [componenti del DBMS](/1762526740.md#struttura%20fisica)
...
Il [transaction manager](/1762526740.md#struttura%20fisica) concede la il lock alla transazione secondo il seguente schema
...
>[!TIP] in breve non si può accedere in scrittura se qualcuno sta usando la risorsa, mentre si puo accedere in lettura se tutti stanno leggendo
...
- in caso di [indici](/1762526725.md) si richiede il lock a livello di foglia che soddisfa il predicato

## Lock management: implementazione

Per poter implementare la gestione dei lock il [lock manager](/1762526740.md#struttura%20fisica)  mantiene in memoria:
