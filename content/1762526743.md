...
layout: simple
aliases:
  - /databases_tecnologies/transazioni/index.md
  - /databases_tecnologies/transazioni
permalink: /databases_tecnologies/transazioni/index.md
date: 2025-02-08
id: transazioni
title: Transazioni
...
Garantire tali proprietà e compito dei  [componenti del DBMS](databases_tecnologies/struttura_database.md#struttura%20fisica)
...
Il [transaction manager](databases_tecnologies/struttura_database.md#struttura%20fisica) concede la il lock alla transazione secondo il seguente schema
...
- in caso di [indici](content/databases_technologies/1762526725.md) si richiede il lock a livello di foglia che soddisfa il predicato

## Lock management: implementazione

Per poter implementare la gestione dei lock il [lock manager](databases_tecnologies/struttura_database.md#struttura%20fisica)  mantiene in memoria:
