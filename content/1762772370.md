...
Navidrome can expose a [prometheus compatible endpoint](https://www.navidrome.org/docs/usage/monitoring/) that can be scraped from prometheus, data can than be displayed with grafana.
