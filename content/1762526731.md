...
layout: simple
aliases:
  - /databases_tecnologies/ottimizzazione_interrogazioni/index.md
  - /databases_tecnologies/ottimizzazione_interrogazioni
permalink: /databases_tecnologies/ottimizzazione_interrogazioni/index.md
...
l'output di questo componente e una **rappresentazione ad albero della query** simile alla forma sql con gli [Operatori logici](/databases_tecnologies/operatori_relazionali#operatori-logici)  come nodi dell'albero e le relazioni come foglie
...
>[!WARNING] non e sempre possibile, per esempio l' operatore [sort](/databases_tecnologies/sorting) necessita di visionare tutto l'input prima di fornire la prima tupla di output
