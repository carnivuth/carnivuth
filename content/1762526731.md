...
aliases:
  ...
  - /1762526731
  - /Database-Technologies-and-Designs/1762526731
  - /Database-Technologies-and-Designs/Ottimizzazione-delle-interrogazioni
...
image: /rappresentazione_interna_query.png
layout: simple
show_image: false
...
Per rispondere a una query il DBMS necessita di determinare qual'e il piano di accesso ottimale per tirare su i dati richiesti dal disco, Il componente dedito a questa mansione e il [query optimizer](/1762526740.md#struttura-fisica) che data una query genera un **piano di accesso** ottimale
...
l'output di questo componente e una **rappresentazione ad albero della query** simile alla forma sql con gli [Operatori logici](/1762526730.md#operatori-logici)  come nodi dell'albero e le relazioni come foglie
