...
Come visto prima e fondamentale determinare la [selettività](/selezione#stimare-il-numero-di-risultati) di un predicato per stimarne i record in output, **assumendo una distribuzione uniforme dei valori degli attributi**
...
## Gestione del [group by](/group_by)
