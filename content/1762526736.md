...
aliases:
  ...
  - /1762526736
  - /Database-Technologies-and-Designs/1762526736
  - /Database-Technologies-and-Designs/Ricerca-del-piano-di-accesso
...
draft: false
image: /programmazione_dinamica.png
layout: simple
show_image: false
...
Come visto prima e fondamentale determinare la [selettività](/1762526737.md#stimare-il-numero-di-risultati) di un predicato per stimarne i record in output, **assumendo una distribuzione uniforme dei valori degli attributi**
...
## Selettività del [join](/1762526728.md)
...
## Cardinalità della [proiezione](/1762526733.md)
...
> troppo costoso
- campionare i dati
- usare metodi hash con modelli probabilistici (alla [cardenas](/1762526719.md#modello-di-cardenas))
...
- Uso di un solo [indici](/1762526725.md) (*eventualmente clustered*)
- Uso di più [indici](/1762526725.md)
- Uso solo di un indice (*non si accede ai dati*)

## Ottimizzare query con più relazioni

In caso di relazioni multiple  e necessario comprendere come ordinare le operazioni di [join](/1762526728.md), date le sue proprietà lo spazio di ricerca e **esponenziale nel numero $n$ di relazioni**
...
## Gestione del [group by](/1762526724.md)
