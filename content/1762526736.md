...
layout: simple
aliases:
  - /databases_tecnologies/ricerca_piano_accesso/index.md
  - /databases_tecnologies/ricerca_piano_accesso
permalink: /databases_tecnologies/ricerca_piano_accesso/index.md
...
Come visto prima e fondamentale determinare la [selettività](/databases_tecnologies/selezione#stimare-il-numero-di-risultati) di un predicato per stimarne i record in output, **assumendo una distribuzione uniforme dei valori degli attributi**
...
## Selettività del [join](/databases_tecnologies/join)
...
## Cardinalità della [proiezione](/databases_tecnologies/proiezione)
...
> troppo costoso
- campionare i dati
- usare metodi hash con modelli probabilistici (alla [cardenas](/databases_tecnologies/b+tree#modello-di-cardenas))
...
- Uso di un solo [indici](/databases_tecnologies/indici) (*eventualmente clustered*)
- Uso di più [indici](/databases_tecnologies/indici)
- Uso solo di un indice (*non si accede ai dati*)

## Ottimizzare query con più relazioni

In caso di relazioni multiple  e necessario comprendere come ordinare le operazioni di [join](/databases_tecnologies/join), date le sue proprietà lo spazio di ricerca e **esponenziale nel numero $n$ di relazioni**
...
## Gestione del [group by](/databases_tecnologies/group_by)
