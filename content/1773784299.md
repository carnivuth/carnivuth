...
aliases:
  - /Funzioni-hash
  - /1773784299
  - /information-security/1773784299
  - /information-security/Funzioni-hash
book: "information security"
book_order: 2
categories:
  - "information security"
date: 2024-06-27
description: trasformazione per l' integrità
draft: false
show_image: false
...
In uno scenario dove l'[autenticazione e implementata per mezzo della funzione hash](/1773784308.md#hash-di-un-segreto), la compressione iterata consente all' attaccante di generare messaggi e valori di hash validi senza conoscere il segreto $S$ quando il messaggio inviato sul canale e della forma:
...
Un'altra possibile contromisura e l'impronta di un impronta, ne esistono diverse varianti qui si riporta HMAC meccanismo utilizzato da [IPSEC](/1773784301.md) e [SSL](/1773784312.md)
...
Questa proprietà e fondamentale per l'utilizzo della funzione hash negli scenari di [firma digitale](/1773784308.md#firma-digitale) in cui viene intrapresa la firma dell' hash di un messaggio.
