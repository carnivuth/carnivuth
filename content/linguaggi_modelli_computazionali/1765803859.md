...
aliases:
  - /Interpreti
  - /1765803859
  - /Linguaggi-e-modelli-computazionali/1765803859
  - /Linguaggi-e-modelli-computazionali/Interpreti
book: "Linguaggi e modelli computazionali"
book_order: 13
date: 2024-10-15
description: Applicare una semantica ai linguaggi riconosciuti
draft: false
image: /1777217810.png
locale: en-US
show_image: false
...
si potrebbero usare gli [alberi di derivazione](/1765803858.md#alberi-di-derivazione) ma questi risultano ridondanti e inefficienti, si ricorre quindi a una rappresentazione ridotta chiamata **abstract syntax tree**
...
In cui ogni classe implementa in metodi per la generazione del singolo sottonodo dell [AST](/1765803859.md#interpretazione-differita-(abstract-syntax-tree))

## Valutare gli alberi

Gli [AST](/1765803859.md#interpretazione-differita-(abstract-syntax-tree)) prodotti da un parser necessitano di essere di conseguenza interpretati tramite opportune operazioni di visita degli alberi, 3 possibili approcci:
...
Ogni specializzazione dell'interfaccia `Expr` definisce i metodi per la generazione del proprio nodo dell [AST](/1765803859.md#interpretazione-differita-(abstract-syntax-tree)), molto più leggibile e modulare ma rende complesso fornire interpretazioni diverse dello stesso [ast](/1765803859.md#interpretazione-differita-(abstract-syntax-tree))
...
E inoltre opportuno considerare se distinguere i due valori sintatticamente in quanto la grammatica risultante in caso di non distinzione diventa [LL(2)](/1765803853.md#grammatiche-$ll(k)$)
...
Tutto cio si traduce in un estensione dell [AST](/1765803859.md#interpretazione-differita-(abstract-syntax-tree)) con le classi per rappresentare gli oggetti sopracitati
