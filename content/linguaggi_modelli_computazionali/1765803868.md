...
aliases:
  - /Scala
  - /1765803868
  - /Linguaggi-e-modelli-computazionali/1765803868
  - /Linguaggi-e-modelli-computazionali/Scala
book: "Linguaggi e modelli computazionali"
book_order: 19
date: 2024-10-31
description: Linguaggio blended di natura accademica
draft: false
image: /1777217806.png
show_image: false
...
tags:
  - languages
thumbnail: /1777217806.png
title: Scala
---

Scala è uno degli esempi più fiorenti di [linguaggio blended](/1765803862.md), riprende molte caratteristiche dei linguaggi funzionali e possiede inoltre un type system forte
...
Le funzioni sono introdotte dalla parola chiave `def` e specifica di tipo postfissa (*anziché prefissa come in C e Java*), e solitamente viene omessa se può essere inferita
...
Il pieno supporto alle funzioni come [first-class objects](/1765803865.md#funzioni-come-first-class-entities) comporta un altrettanto pieno supporto alle [chiusure](/1765803865.md#chiusura), per cui viene preferita la chiusura lessicale e le variabili libere **vengono chiuse per mezzo di riferimenti alle variabili esterne**, ciò significa che risentono dei cambiamenti ad esse
...
- block like syntax
- [currying](/1765803860.md#currying)
- [call by name](/1765803865.md#alternativa-modello-call-by-name)
- [chiusura](/1765803865.md#chiusura)
...
Scala introduce il tipo `Option` come analogo degli optional di java, questo per evitare argomenti passati come null (*si ricorda che ciò in scala non  e possibile per la [gerarchia di tipi](/1765803862.md#tipi)*)

## Extractors

Le funzionalità di [pattern matching](#pattern-matching) di scala come definite sopra sono utilizzabili solo per mezzo di [classi dati](/1765803862.md#classi-dati), per poterle utilizzare anche con oggetti generati da classi normali scala mette a disposizione gli **extractors**,  ovvero oggetti che definiscono un metodo `unapply()` duale di `apply()` che estrae i valori di un oggetto
...
## [Interpreti](/1765803859.md) in scala: la libreria parser `combinators`
...
In caso di grammatiche [ll(1)](/1765803853.md) la libreria genera comunque un parser in grado di fare backtracking, per evitare l'inefficienza e utile specificare che non e necessario supportarlo con l'operatore `!`
