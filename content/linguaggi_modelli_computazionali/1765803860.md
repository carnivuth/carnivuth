...
aliases:
  - /Javascript
  - /1765803860
  - /Linguaggi-e-modelli-computazionali/1765803860
  - /Linguaggi-e-modelli-computazionali/Javascript
book: "Linguaggi e modelli computazionali"
book_order: 16
date: 2024-10-24
description: Object based language con un interessante modello a oggetti
draft: false
image: https://cdn.jsdelivr.net/gh/homarr-labs/dashboard-icons/svg/javascript-light.svg
show_image: false
...
tags:
  - languages
thumbnail: https://cdn.jsdelivr.net/gh/homarr-labs/dashboard-icons/svg/javascript-light.svg
title: Javascript
locale: en-US
---
...
- un ambiente globale mal definito
...
javascript implementa le funzioni come [first class entities](/1765803865.md#funzioni-come-first-class-entities), e dunque possibile creare [chiusure](/1765803865.md#chiusura)
...
Particolare caso di chiusura in cui funzioni a $n$ argomenti vengono simulate per mezzo di chiusure di funzioni a un argomento (*utilizzato per il [Lambda Calcolo](/1765803861.md)*)
...
A default le proprietà di un oggetto sono tutte pubbliche, e possibile implementare una proprietà privata per mezzo di una [chiusura](/1765803865.md#chiusura)
