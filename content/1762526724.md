...
layout: simple
aliases:
  - /databases_tecnologies/group_by/index.md
  - /databases_tecnologies/group_by
permalink: /databases_tecnologies/group_by/index.md
...
Una delle possibilità e quella di sfruttare tecniche di ordinamento come quelle viste per la [proiezione](/databases_tecnologies/proiezione#proiettare-ordinando), va sommato il costo di calcolo delle funzioni aggregate
...
>[!TIP] in caso di [b+tree](/databases_tecnologies/b+tree) se gli attributi di raggruppamento sono un prefisso della chiave si può utilizzare l'indice per accedere al file dati in maniera ordinata

## Group by usando hashing

Si costruisce una tabella di hash in memoria centrale in maniera analoga al caso della [proiezione](/databases_tecnologies/proiezione#proiettare-usando-hashing)
