...
Una delle possibilità e quella di sfruttare tecniche di ordinamento come quelle viste per la [proiezione](/proiezione#proiettare-ordinando), va sommato il costo di calcolo delle funzioni aggregate
...
Si costruisce una tabella di hash in memoria centrale in maniera analoga al caso della [proiezione](/proiezione#proiettare-usando-hashing)
