---
aliases:
  - /Mimic-overleaf-using-vim-and-make
  - /1763124366
  - /notes/1763124366
  - /notes/Mimic-overleaf-using-vim-and-make
book: "posts"
date: '2025-04-09'
description: "how to recreate overleaf with style locally"
draft: false
image: /1777217828.png
show_image: false
...
So the first thing to address was the compilation of latex files cause without it the project was doomed from the beginning so i started to look the latex build system and i quickly discovered `latexmk` which i decided to wrap around a [`makefile`](/1762772367.md) that would build also the graphs using mermaid as a dependency
