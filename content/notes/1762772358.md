...
images:
  - https://cdn.jsdelivr.net/gh/homarr-labs/dashboard-icons/svg/ansible-light.svg
layout: simple
locale: en-US
show_image: false
...
tags:
  ...
  - Ci/Cd
  - infrastructure
thumbnail: https://cdn.jsdelivr.net/gh/homarr-labs/dashboard-icons/svg/ansible-light.svg
title: ansible
---
...
### Run specific part of a play

To run specific parts of a play the flag `--since` can be used or tags
...
```
> [!TIP]
> this play could be filtered with tags `configuration,packages,webservers`

## Splitting strings in multiple lines:

This is not an ansible exclusive but a `yaml` thing, to split strings `>` and `|` operators can be used, the first one will replace newlines with spaces and the second one will keep them, for example:Z
...
Becomes `this is my very very very\nlong string\n` and this
...
Becomes `this is my very very very long string\n`
