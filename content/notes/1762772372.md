...
LSP is a protocol to manage interaction between code editors and process providing code completion and  syntax highlighting
...
- To check the detected filetype (*useful when troubleshooting Lsp and Treesitter linters*)
