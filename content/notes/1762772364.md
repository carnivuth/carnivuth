...
tags:
  ...
  - Ci/Cd
title: jenkins
thumbnail: https://cdn.jsdelivr.net/gh/homarr-labs/dashboard-icons/svg/jenkins.svg
---

[Jenkins](https://www.jenkins.io) is a CI service that can build and test software from different VCS, run automation tasks, integrate with ansible and much more, it's based around the concept of **builds**, builds are composed of a sequence of actions that  are executed on **build nodes**, build notes are enivronments that run the software build workflow
...
## Create a Jenkins CI pipeline for [github](https://github.com) repository
