...
[CNN](1774305280.md) Inspired by [VGG](1774305322.md) based on the concept of [residual blocks](1774305280.md#RESIDUAL%20LEARNING%20AS%20A%20SOLUTION), each stage of a resnet consists in a combination of residual blocks

![](/Pasted-image-20241001122748.png)

## Residual block structure

each residual block (*RB*) contains 2 stages of $3 \times 3$ convolution and [ReLU](1774305282.md#ACTIVATION%20FUNCTION) non-linearity, the input of a RB block is summed to the output
...
To improve performance the convolution step is performed as a [depthwise convolutions](1774305280.md#DEPTHWISE%20SEPARABLE%20CONVOLUTIONS), another improvement (*proved by experimental evidence*) is the absence of non linear blocks between residual blocks
## Resnet training
