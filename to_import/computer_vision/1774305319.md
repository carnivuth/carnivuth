...
The first guess is obtained as the median between the $R_{i}$ $T_{i}$ computed by chaining the [transformations](1774305307.md#ACCOUNTING%20FOR%20ROTATION%20AND%20TRANSLATION) $G_i(G_j^{-1})$
