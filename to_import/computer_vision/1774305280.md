...
Convolutional layers are a form of linear transformation (they can be expressed by matrix) so in order to take advantage of network depth there is the need to chain them with some form of non-linearity (e.g. [relu](1774305282.md#ACTIVATION%20FUNCTION))
...
In order to reduce the number of parameter at the begin of the [FC layers](1774305282.md#FULLY%20CONNECTED%20LAYERS) the output can be processed by average pooling
